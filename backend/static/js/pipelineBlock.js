...
export function createPipelineBlock({
  messages,
  provider
}) {
  ...
  applyGitlab.className =
    "save-btn";

  applyGitlab.innerHTML =
    "🦊 Aplicar no GitLab";
  ...
  gitlabEditor.className =
    "editor";

  gitlabEditor.placeholder =
    "Pipeline GitLab aparecerá aqui...";
  ...
  applyGithub.className =
    "save-btn";

  applyGithub.innerHTML =
    "🐙 Aplicar no GitHub";
  ...
  githubEditor.placeholder =
    "GitHub Actions aparecerá aqui...";
